...
```javascript
const tokenAddress = '0xb70af9f61c417a299476759b88541a655fd0275e';
const tokenSymbol = 'KT';
const tokenDecimals = 18;
const tokenImage = 'https://fikapark-resources.s3.ap-northeast-1.amazonaws.com/logo_transp_32x32.png';
